...
public:
	...
	void DisplayPlayer(const bool& Winner,const float& explosioncounter);
	...
	void UpgradeBulletSpeed(int speedIncrease);
	void UpdateUnits();
	void Collision();
	void DrawYouDied();
...
private:
	...
	std::string YouDiedText{ "You Died" };
	std::string youWonText{ "Enemy Felled" };
